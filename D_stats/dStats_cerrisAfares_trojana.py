...
out_cerrisAfares_trojana = bb.results_table.sort_values(by="Z", ascending=False)
taxa_cerrisAfares_trojana = bb.taxon_table.iloc[out_cerrisAfares_trojana.index]

out_cerrisAfares_trojana.to_csv('bb.dstat.sorted_cerrisAfares_trojana_full.csv', sep = ',')
taxa_cerrisAfares_trojana.to_csv('bb.dstat.taxa_cerrisAfares_trojana_full.csv', sep = ',')
