...
out_suberCerris = bb.results_table.sort_values(by="Z", ascending=False)
taxa_suberCerris = bb.taxon_table.iloc[out_suberCerris.index]

out_suberCerris.to_csv('bb.dstat.sorted_suberCerris_full.csv', sep = ',')
taxa_suberCerris.to_csv('bb.dstat.taxa_suberCerris_full.csv', sep = ',')
